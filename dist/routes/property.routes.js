...
const publicLimiter = (0, ratelimit_middleware_1.rateLimiter)(100, 60, 'property');
// Public
...
router.delete('/:id', auth_middleware_1.requireAdmin, propertyController.deleteProperty);
